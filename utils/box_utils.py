...
def match(cfg, box_gt, anchors, class_gt):
    #print('box_gt : ',box_gt,'Shape :',box_gt.size())
    #print('anchors : ',anchors,'Shape : ',anchors.size())
    #print('class_gt : ',class_gt,'Shape : ',class_gt.size())
    ...
    #print('DECODE PRIORS : ',decoded_priors,'Shape : ',decoded_priors.size())
    #print('overlaps : ',overlaps,'Shape : ',overlaps.size())
    #print('gt_max_i : ',gt_max_i,'Shape : ',gt_max_i.size())
    #print('each_anchor_max : ',each_anchor_max,'Shape : ',each_anchor_max.size())
    ...
    #print('EACH ANCHOR MAX : ',each_anchor_max,'Shape : ',each_anchor_max.size())
    #print('anchor_max_i : ',anchor_max_i,'Shape : ',anchor_max_i.size())
    #print('anchor_max_gt : ',anchor_max_gt,'Shape : ',anchor_max_gt.size())
    #print('anchor at specific : ',anchor_max_gt[gt_max_i])
    #print('anchor max index at specific : ',anchor_max_i[gt_max_i])
    conf = class_gt[anchor_max_i] + 1  # the class of the max IoU gt box for each anchor
    #print('conf : ',conf,'Shape : ',conf.size())
    ...
    #print('OFFSETS : ',offsets,'Shape : ',offsets.size())

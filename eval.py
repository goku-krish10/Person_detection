...
parser.add_argument('--weight', type=str, default=None, help='The validation model.')
...
def evaluate(net, cfg, step=None):
    ...
    if cfg.coco_api:
        ...
        table, box_row, mask_row = calc_map(ap_data, iou_thres, len(cfg.class_names), step=step, pr_graph=True)
        print(table)
